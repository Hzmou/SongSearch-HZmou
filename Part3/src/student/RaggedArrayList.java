 ...
 *                           Revision History
 * ****************************************************************************
 * 22/02/2022 - Hamza Zmou- finished a revised version of findEnd() using while
 * loops for linear search of the l1Array and l2Array without violating any of
 * the code conventions of the course
 * 20/02/2022 - Hamza Zmou- Started working on  a revised version of findEnd().
 * 14/02/2022- Hamza Zmou - Added proper documentation and comments to findEnd()
 * 13/02/2022- Hamza Zmou - finished the implementation of findEnd() method.
...
public class RaggedArrayList<E> implements Iterable<E> {
     ...
     * this might be an unused slot at the end of a level 2 array Author: Hamza
     * Zmou- Revised version
     *
     *
     * @param item the thing we are searching for a place to put.
     ...
     * insertion position Authors: Aidan Bradley - Hamza Zmou
     *
     * @param item the thing we are searching for a place to put.
     * @return
     */
